...
@pytest.mark.asyncio
async def test_logs_screen_starts_selected_at_last_line(monkeypatch) -> None:
    def fake_load_startup_targets(startup_config: StartupConfig) -> StartupConfig:
        return startup_config
...
@pytest.mark.asyncio
async def test_logs_navigation_turns_off_follow(monkeypatch) -> None:
    def fake_load_startup_targets(startup_config: StartupConfig) -> StartupConfig:
        return startup_config
...
@pytest.mark.asyncio
async def test_logs_screen_supports_mouse_selection(monkeypatch) -> None:
    def fake_load_startup_targets(startup_config: StartupConfig) -> StartupConfig:
        return startup_config
